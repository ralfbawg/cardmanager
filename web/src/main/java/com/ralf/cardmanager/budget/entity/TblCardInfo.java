...
@Table(name="tbl_card_info", alias="a", columns={
		...
		@Column(name="card_num", attrName="cardNum", label="卡号", isInsert=false),
		@Column(name="budget_id", attrName="budgetId.id", label="budget_id", isInsert=false),
		...
		@Column(name="last_charge_on", attrName="lastChargeOn", label="上次充值时间", isInsert=false),
		@Column(name="billing_address", attrName="billingAddress", label="账单地址"),
		@Column(name="card_owner", attrName="cardOwner", label="同card_holder", isInsert=false),
		@Column(name="category", attrName="category", label="category"),
		@Column(name="cvv", attrName="cvv", label="cvv", isInsert=false),
		@Column(name="exp", attrName="exp", label="exp", isInsert=false),
		@Column(name="status", attrName="status", label="卡状态", comment="卡状态:actived,delete,freezed"),
		@Column(name="card_token", attrName="cardToken", label="用来获取卡号 cvv 过期时间", isInsert=false),
		@Column(name="card_id", attrName="cardId", label="card_id", isInsert=false),
		...
		@Column(name="card_brand", attrName="cardBrand", label="卡品牌 master", isInsert=false),
		@Column(name="pan_url", attrName="panUrl", label="获取卡号", isInsert=false),
		@Column(name="user_allocation_id", attrName="userAllocationId", label="user_allocation_id", isInsert=false),
	}, orderBy="a.id ASC"
)
public class TblCardInfo extends DataEntity<TblCardInfo> {
	...
	@Length(min=0, max=64, message="budget_id长度不能超过 64 个字符")
