package com.ralf.cardmanager.spider.task.epaylinks.operation.base;
...
import com.ralf.cardmanager.spider.task.epaylinks.exception.NotInitedException;
...
public abstract class BaseEpaylinksOperation<T extends BaseEpaylinksOpertionResp> extends BaseOperation {
    ...
    public void packageParams() {
        ...
        defaultHeader.put("authorization", "Bearer " + SpringContextUtil.getBean(EpaylinksSiteConfig.class).authToken);
    }
