...
public class GetVirtualCardDetailsInfo extends BaseDivvyOperation<GetVirtualCardDetailsInfoRsp> {
    ...
    public GetVirtualCardDetailsInfo(DivvyPaySiteConfig config) {
        super(config);
        this.body = "{\"operationName\":\"GetVirtualCardDetailsInfo\",\"variables\":{\"cardId\":\"%s\"},\"query\":\"query GetVirtualCardDetailsInfo($cardId: ID!) {\\n  node(id: $cardId) {\\n    ... on Card {\\n      id\\n      frozen\\n      name\\n      deleted\\n      budget {\\n        id\\n        name\\n        __typename\\n      }\\n      assignedTagValues(first: 1000) {\\n        edges {\\n          node {\\n            id\\n            tagType {\\n              deleted\\n              id\\n              name\\n              __typename\\n            }\\n            tagValue {\\n              id\\n              value\\n              __typename\\n            }\\n            __typename\\n          }\\n          __typename\\n        }\\n        __typename\\n      }\\n      userAllocation {\\n        id\\n        budget {\\n          name\\n          id\\n          __typename\\n        }\\n        __typename\\n      }\\n      user {\\n        id\\n        displayName\\n        avatarUrl\\n        company {\\n          id\\n          address {\\n            city\\n            state\\n            street1\\n            street2\\n            zipCode\\n            __typename\\n          }\\n          __typename\\n        }\\n        __typename\\n      }\\n      __typename\\n    }\\n    __typename\\n  }\\n}\\n\"}";
    }
    ...
    public CreateCardStep2.CreateCardStep2Resp persistent(String rsp) throws IOException {
        ...
        return new GetVirtualCardDetailsInfoRsp(deleted, frozen);
    }
}

@Data
@AllArgsConstructor
class GetVirtualCardDetailsInfoRsp extends BaseDivvyOpertionResp {
